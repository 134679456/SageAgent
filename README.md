...
它完成了 RAG 系统从文档入库到智能问答全链路的比较完整的工程实现。做 RAG 会遇到的问题——文档解析、分块策略、多路检索、意图识别、问题重写、会话记忆、模型容错、MCP 工具调用、链路追踪——Ragent 里都有对应的解决方案。
...
## 贡献与支持
文档是人工 + AI辅助费心费力编写的，如果这个项目对你有帮助，请给个宝贵的 Star ⭐️⭐️⭐️⭐️⭐️！
